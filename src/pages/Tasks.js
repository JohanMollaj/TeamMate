...
export default function(){
  ...
  // Get current date for due soon calculations
  const now = new Date();
                    ...
                    <div className='sections'>
                        ...
                        <div className="section assignments">
                            ...
                            {tasks.length === 0 ? (
                              ...
                              <>
                                <div className='assignments-container'><DueSoonTasks tasks={dueSoonTasks} /></div>
                                <div className='assignments-container'><InProgressTasks tasks={pendingTasks} /></div>
                                <div className='assignments-container'><CompletedTasks tasks={completedTasks} /></div>
                              </>
                            )}
                        </div>
                    </div>
